from constants_tf import TFType
from modules.inference.types_tf import DataType
from protos.tensorflow.core.framework.tensor_pb2 import TensorProto
from protos.tensorflow.core.framework.tensor_shape_pb2 import TensorShapeProto
import numpy as np
...
def tensor_proto_to_ndarray(tensor_proto: TensorProto) -> np.ndarray:
    ...
    if dtype.numpy_dtype == np.str_:
        return proto_values # FIXME: make general
    else:
